...
if(!window.mmcore){
	...
	cookie_domain: '.' + location.hostname.match(/\w*\-*\w*\.\w*$/)[0],
	tpixel:false,
	cprefix:'mmcore.',
	inline_state:true,
...
/*If the hostname is an IPv4 or IPv6 address and mmcore.cookie_domain is not the same as the hostname,*/
/*mmcore.SetCookie is not working because mmcore._Host it uses returns an incorrect hostname (dot plus the IP).*/
/*Make mmcore._Host always returning a valid hostname if an IP address is given.*/
