var s_tc_Etihadcom=new TagContainer('Etihadcom');
...
var s_account = "etihadnewstaging"
var s=s_gi(s_account)
s.dynamicAccountSelection=true
s.dynamicAccountList="etihadnewstaging=test.etihadairways.com,test.etihad.com,cert.booking.etihad.com, cert.ebooking.etihad.com, cert.mbooking.etihad.com,eps.prod.etihadairways.com,test.modules.etihad.com,dev.modules.etihad.com,ppe.modules.etihad.com,beta.holidays.etihad.com,res.beta.holidays.etihad.com;etihaddotcomprod,etihadmobileprod=m.etihadairways.com,mobile.etihadairways.com,m.etihad.com,mobile.etihad.com,mbooking.etihad.com;etihaddotcomprod,etihaddotcomprodcopyformctest=etihadairways.com,careers.etihadairways.com,etihad.com,careers.etihad.com,ebooking.etihad.com,booking.etihad.com,modules.etihad.com,res.holidays.etihad.com,holidays.etihad.com"
...
s.linkInternalFilters="javascript:,etihadairways.com,etihad.com"
...
s.prop16 = s.eVar16 = s.getTimeParting('s', currentTimeZoneOffsetInHours);


/* Internal Search Query */
if (!s.prop9) s.prop9 = s.getQueryParam('q');
if (s.prop9) s.prop9 = s.prop9.toLowerCase();

/* External Campaigns  */
if (!s.campaign) s.campaign = s.getQueryParam('cid');
if (s.campaign) s.campaign = s.campaign.toLowerCase();

/* Campaign Stacking */
s.prop14 = s.eVar14 = s.crossVisitParticipation(s.campaign, 's_ev14', '30', '5', '>', '', 1);

/* Get Previous Page*/
s.prop17 = s.eVar17 = s.getPreviousValue(s.pageName, 'gpv_e17', '');

/* Build Content ID (prop15) */
s.prop15 = s.prop1 + ":" + s.pageName;

/* Build PNRTimestamp (s.eVar50) */
s.eVar50 = s.purchaseID;
...
/*
61.s.events="event10"	Book Chauffeur Start		Set when s.pageName="plan-and-book:book-chauffeur"
...
*/
	if(s.pageName.indexOf("plan-and-book:book-chauffeur") != -1){
		s.events=s.apl(s.events,"event10",",",2);
	}
	if(s.pageName.indexOf("newsletter") != -1){
		s.events=s.apl(s.events,"event12",",",2);
	}
	if(s.pageName.indexOf("newsletter:confirmation") != -1){
		s.events=s.apl(s.events,"event13",",",2);
	}
	if(s.pageName.indexOf("eyey:upgrade_ancillary_page") != -1){
		s.events=s.apl(s.events,"event22",",",2);
	}
	if(s.pageName.indexOf("eyey:upgrade_confirmation_page") != -1){
...
*/
	if(s.pageName.indexOf("etihadguest:join") != -1){
		if(s.pageName.indexOf("etihadguest:join:confirmation") != -1) {
...
*/
	if(s.pageName.indexOf("eyey:purchase_page") != -1 || s.pageName.indexOf("eym0:purchase_page") != -1){
	   	s.events=s.apl(s.events,"scCheckout",",",2)
	}
	if(s.pageName.indexOf("eyey:confirmation_page") != -1 || s.pageName.indexOf("eym0:confirmation_page") != -1){
	   	s.events=s.apl(s.events,"purchase",",",2)
	}
	if(s.pageName.indexOf("eyey:air_select_page") != -1 || s.pageName.indexOf("eym0:air_select_page") != -1){
	   	s.events=s.apl(s.events,"event1",",",2)
	}
	if(s.pageName.indexOf("eyey:passengers_page") != -1 || s.pageName.indexOf("eym0:passengers_page") != -1){
	   	s.events=s.apl(s.events,"event2",",",2)
	}
	if(s.pageName.indexOf("eyey:exchange_air_search_page") != -1 || s.pageName.indexOf("eym0:exchange_air_search_page") != -1){
	   	s.events=s.apl(s.events,"event6",",",2)
	}
	if(s.pageName.indexOf("eyey:exchange_confirmation_page") != -1 || s.pageName.indexOf("eym0:exchange_confirmation_page") != -1){
	   	s.events=s.apl(s.events,"event7",",",2)
	   	s.events=s.apl(s.events,"event18",",",2)
	}
	if(s.pageName.indexOf("eyey:check_in_start_page") != -1 || s.pageName.indexOf("eym0:check_in_start_page") != -1){
...
*/
	if(s.pageName && s.prop7) {
		if(s.pageName.indexOf("eyey:confirmation_page") != -1 && s.prop7.indexOf("redemption") != -1) {
...
*/
	if(s.prop19) {
		if(s.prop19.indexOf("hertz") != -1 || s.prop19.indexOf("kuoni") != -1) {
...
if (s.prop1 && !s.eVar1) s.prop1 = s.eVar1 = s.prop1.toLowerCase();
if (s.prop2 && !s.eVar2) s.prop2 = s.eVar2 = s.prop2.toLowerCase();
if (s.prop3 && !s.eVar3) s.prop3 = s.eVar3 = s.prop3.toLowerCase();
if (s.prop4 && !s.eVar4) s.prop4 = s.eVar4 = s.prop4.toLowerCase();
if (s.prop5 && !s.eVar5) s.prop5 = s.eVar5 = s.prop5.toLowerCase();
if (s.prop6 && !s.eVar6) s.prop6 = s.eVar6 = s.prop6.toLowerCase();
if (s.prop7 && !s.eVar7) s.eVar7 = s.prop7.toLowerCase();
if (s.prop8 && !s.eVar8) s.prop8 = s.eVar8 = s.prop8.toLowerCase();
if (s.prop9 && !s.eVar9) s.prop9 = s.eVar9 = s.prop9.toLowerCase();
if (s.prop10 && !s.eVar10) s.prop10 = s.eVar10 = s.prop10.toLowerCase();
if (s.prop11 && !s.eVar11) s.prop11 = s.eVar11 = s.prop11.toLowerCase();
if (s.prop12 && !s.eVar12) s.prop12 = s.eVar12 = s.prop12.toLowerCase();
if (s.prop14 && !s.eVar14) s.prop14 = s.eVar14 = s.prop14.toLowerCase();
if (s.prop15 && !s.eVar15) s.prop15 = s.eVar15 = s.prop15.toLowerCase();
if (s.prop17 && !s.eVar17) s.prop17 = s.eVar17 = s.prop17.toLowerCase();
if (s.prop18) s.prop18 = s.prop18.toLowerCase();
if (s.eVar18) s.eVar18 = s.eVar18.toLowerCase();
if (s.prop19) s.prop19 = s.prop19.toLowerCase();
if (s.eVar19) s.eVar19 = s.eVar19.toLowerCase();
if (s.prop24 && !s.eVar24) s.prop24 = s.eVar24 = s.prop24.toLowerCase();
...
s.visitorNamespace = "etihadairways"
s.trackingServer = "metrics.etihad.com"
s.trackingServerSecure = "smetrics.etihad.com"

s.setTagContainer("Etihadcom")
